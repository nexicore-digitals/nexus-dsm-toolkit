 ...
 */
export function transformPapaParseError(papaError) {
    switch (papaError.code) {
        case "MissingQuotes":
            const missingQuotesError = {
                name: "CSVMissingQuotesError",
                message: `Missing quote on line ${papaError.row !== undefined ? papaError.row + 1 : "N/A"}. ${papaError.message}`,
                type: "SyntaxError",
                code: "MissingQuotes",
        ...
        case "InvalidQuotes":
            const invalidQuotesError = {
                name: "CSVInvalidQuotesError",
                message: `Malformed quote on line ${papaError.row !== undefined ? papaError.row + 1 : "N/A"}. ${papaError.message}`,
                type: "SyntaxError",
                code: "InvalidQuotes",
                row: papaError.row !== undefined ? papaError.row : undefined,
                index: papaError.index,
        ...
        case "UndetectableDelimiter":
            const undetectableDelimiterError = {
        ...
        case "TooFewFields":
            const tooFewFieldsError = {
                name: "CSVTooFewFieldsError",
                message: `Too few fields on line ${papaError.row !== undefined ? papaError.row + 1 : "N/A"}. Expected more columns. ${papaError.message}`,
        ...
        case "TooManyFields":
            const tooManyFieldsError = {
                name: "CSVTooManyFieldsError",
                message: `Too many fields on line ${papaError.row !== undefined ? papaError.row + 1 : "N/A"}. Expected fewer columns. ${papaError.message}`,
                type: "FieldMismatchError",
                code: "TooManyFields",
                row: papaError.row !== undefined ? papaError.row : undefined,
            };
        ...
        default:
            ...
            const unexpectedError = {
                ...
                message: `An unknown Papa Parse error occurred: ${papaError.message} (Code: ${papaError.code || "N/A"})`,
...
//# sourceMappingURL=papaparse.adapter.js.map